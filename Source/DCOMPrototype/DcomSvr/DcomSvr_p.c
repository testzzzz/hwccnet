...
typedef struct _DcomSvr_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } DcomSvr_MIDL_TYPE_FORMAT_STRING;

typedef struct _DcomSvr_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } DcomSvr_MIDL_PROC_FORMAT_STRING;

typedef struct _DcomSvr_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } DcomSvr_MIDL_EXPR_FORMAT_STRING;
...
extern const DcomSvr_MIDL_TYPE_FORMAT_STRING DcomSvr__MIDL_TypeFormatString;
extern const DcomSvr_MIDL_PROC_FORMAT_STRING DcomSvr__MIDL_ProcFormatString;
extern const DcomSvr_MIDL_EXPR_FORMAT_STRING DcomSvr__MIDL_ExprFormatString;
...
static const DcomSvr_MIDL_PROC_FORMAT_STRING DcomSvr__MIDL_ProcFormatString =
    {
        0,
        {
...
static const DcomSvr_MIDL_TYPE_FORMAT_STRING DcomSvr__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IMyObject, ver. 0.0,
   GUID={0xCCB73CBC,0x0E28,0x49F1,{0xAE,0x94,0xE3,0xA1,0x4D,0xE2,0xB3,0xB8}} */
...
static const MIDL_STUBLESS_PROXY_INFO IMyObject_ProxyInfo =
    {
    &Object_StubDesc,
    DcomSvr__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    DcomSvr__MIDL_TypeFormatString.Format,
